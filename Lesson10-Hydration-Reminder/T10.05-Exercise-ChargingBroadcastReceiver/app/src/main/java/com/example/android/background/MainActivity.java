...
public class MainActivity extends AppCompatActivity implements
    ...
    ChargingBroadcastReciever chargingBroadcastReciever;
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(chargingBroadcastReciever, mChargingIntentFilter);
    }
    ...
    private class ChargingBroadcastReciever extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            showCharging(intent.getAction() == Intent.ACTION_POWER_CONNECTED);
        }
    }
